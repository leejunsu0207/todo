...
class TodoRepositoryTest {
    ...
    fun saveAllTest(){
        ...
        val result = todoRepositoryImpl.savaAll(todoList)
    ...
    fun findOneTest(){
        ...
        todoRepositoryImpl.savaAll(todoList)
    ...
    fun findAllTest(){
        ...
        println(result)
        Assertions.assertEquals("테스트 일정1",result[0].title)
        Assertions.assertEquals("테스트 일정2",result[1].title)
        Assertions.assertEquals("테스트 일정3",result[2].title)
